...
env = environ.Env(
    ...
    SQL_USER=(str,),
    SQL_PORT=(int, 5432),
    SQL_HOST=(str, 'localhost'),CELERY_BROKER_URL=env(str,),
    SQL_PASSWORD=(str,),
SSO_DOMAIN=(str,),
...
AUTH_SECRET_KEY = env(")%1nllc!l^6lnwjgmA7tfn9@%9axr_^=^h%krzs&keih+!j+#z")CELERY_BROKER_URL = env('CELERY_BROKER_URL')